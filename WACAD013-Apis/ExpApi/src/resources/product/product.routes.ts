 ...
 */
router.post('/', isAdmin, validateBody(createProductSchema), async (req: Request, res: Response) => {
 ...
 */
router.put('/:id', isAdmin, validateBody(updateProductSchema), async (req: Request, res: Response) => {
  const { id } = req.params;
